...
public class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<PlanningDbContext>
{
    public PlanningDbContext CreateDbContext(string[] args)
    {
        ...
        if (string.IsNullOrEmpty(connectionString))
        {
            ...
            var basePath = Path.Combine(Directory.GetCurrentDirectory(), "..", "Planning.Api");
        ...
        connectionString ??= "Host=localhost;Port=5432;Database=calendarun_planning;Username=calendarun;Password=calendarun";

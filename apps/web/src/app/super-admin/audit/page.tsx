...
function SuperAdminAuditContent() {
  ...
  const hasActiveFilters = Boolean(selectedTenantId || selectedAction || selectedEntityType);
          ...
          <div className="flex flex-wrap items-center gap-4">
            <div className="min-w-[200px]">
              ...
              <Select
                ...
                onValueChange={(value) => {
                  setSelectedTenantId(value === "all" ? "" : value);
                  setCurrentPage(1);
                }}
              >
                <SelectTrigger className="h-9 w-full">
                  <SelectValue placeholder={locale === "tr" ? "Tüm Tenant'lar" : "All Tenants"} />
                </SelectTrigger>
                <SelectContent>
